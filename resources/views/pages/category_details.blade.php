        ...
        <div class="container-fluid">
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1 px-3">
                                        ...
                                        <select class="form-control" name="filterCategory" id="actions" onchange="location = this.value;">
                                            @foreach ($allTerms as $value)
                                                @if ($value->type == "category" && $value->parent!=99)
                                                    <option value="{{route('category_details',['key'=>$value->slug])}}" @if ($value->slug==$category->slug) selected @endif>
                                                        {{$value->name}}
                                                    </option>
                                                @endif
                                            @endforeach
                            ...
                            <div class="col-lg-6 mb-3 ml-0">
                                ...
                                <div class="input-group input-group-merge input-group-flush">
                                    ...
                                    <input id="datatableSearch" type="search" class="form-control" name="search" placeholder="Search post">
                                </div>
                                <!-- End Search -->
                                </form>
                            </div>
            ...
            <div class="container container-changelog">
                <div class="board-top-block">
                    <h1 class="board-block-header">{{$category->name}}</h1>
                </div>
                            ...
                            <div class="card-post mb-5">
                                <div class="post-content">
                                    <div class="d-flex">
                                        ...
                                        <h3 class="post-title">
                                            <a class="raven-post-title-link" href="{{route('postDetail',['id'=>$post->id])}}">{{$post->title}}<sup class="post-comments-count"><i class="far fa-comment"></i>{{' '.$post->comment_count}}</sup></a>
                                        </h3>
                                    </div>
