        ...
        <div class="row justify-content-lg-center">
                        <div class="col-lg-12 mt-5">
                            ...
                            <div class="alert alert-success">
                                    {{session('message')}}
                                    <a href="{{route('changelog.list_posts')}}">Quay lại list posts</a>
                            </div>
                            @endif
                            <div id="addUserProfile" class="card card-lg">
                            <!-- Body -->
                            <form action="{{ route('changelog.post_add_posts')}}" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" id="categories" name="category">
                                                ...
                                                <option value="{{$category->id}}" @if($category->id == 121) selected @endif>{{$category->name}}</option>
                                                @endif
                                                @endforeach
                                            </select>
                                        </div>
