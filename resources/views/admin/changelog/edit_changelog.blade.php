...
<div class="main-content">
    <div class="row justify-content-lg-center">
        <div class="col-lg-12 mt-5">
            ...
            <!-- Body -->
            <form action="{{route('changelog.post_edit_posts')}}" method="POST" enctype="multipart/form-data" novalidate>
                @csrf
                <input type="hidden" name="id" id="" value="{{ $post->id }}">
                <input type="hidden" name="post_type" id="" value="{{ $post->post_type }}">
                <div class="card-header">
                    <h3>Edit post <small>(changelog)</small></h3>
                </div>
                <div class="card-body">
                    <!-- title  -->
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="postParent" class="custom-select">
                                ...
                                @if ($value->post_type == "changelog" && $value->id != $post->id)
