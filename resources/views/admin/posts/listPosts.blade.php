                ...
                <div class="content-title py-4 mb-5">
                    <div class="row align-items-end">
                        ...
                        <div class="col-sm-auto">
                            <a class="btn btn-addPost" href="{{ route('add-post')}}">
                                <i class="fas fa-user-plus"></i> Add new post
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="search mb-1">
                    <div class="row justify-content-between align-items-center flex-grow-1 px-3">
                        <div class="filter mr-5 d-flex" d-flex>
                            <form action="{{route('bulkActionPosts')}}" id="bulkActions" class="d-flex" method="POST">
                                @csrf
                            ...
                            <form action="{{route('limitPosts')}}" method="GET" class="d-flex">
                            ...
                            <form action="{{route('sortPosts')}}" method="GET" >
                            ...
                            <form action="{{route('statusPosts')}}" class="d-flex" method="GET">
                                <div class="form-group">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('edit-get-post',['id'=>$post->id]) }}" class="title-info"
                                            @if (Auth::User()->id==$post->author || Auth::User()->role==2)
                                            @else
                                    ...
                                    <td>
                                        <a href="{{ route('edit-get-post',['id'=>$post->id]) }}" class="btn btn-white btn-edit"
                                            @if (Auth::User()->id==$post->author || Auth::User()->role==2)
                                            @else
                                                onclick="return errorRole()"
                                                style="background-color: rgb(179, 179, 179)"
                                        ...
                                        <a href="{{ route('delete-post',['id'=>$post->id]) }}"  class="btn btn-white btn-edit"
                                            @if (Auth::User()->id==$post->author || Auth::User()->role==2)
