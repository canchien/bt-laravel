        ...
        <div class="row justify-content-lg-center">
                        <div class="col-lg-12 mt-5">
                            ...
                            <div class="alert alert-success">
                                    {{session('message')}}
                                    <a href="{{route('list-posts')}}">Quay lại list road maps</a>
                            </div>
                            @endif
                            <div id="addUserProfile" class="card card-lg">
                            <!-- Body -->
                            <form action="{{ route('postAddRoadmaps')}}" method="POST" enctype="multipart/form-data" novalidate>
                                @csrf
                                <div class="card-header">
                                    <h3>Add New road maps</h3>
                                </div>
                                <div class="card-body">
                                    <!-- title  -->
